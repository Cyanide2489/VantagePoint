  ...
  >
    <div class="flex items-start gap-3">
      ...
      <div class="min-w-0 flex-1">
        <p class="font-medium text-stone-900 leading-snug">
          {{ t(question.text) }}
        </p>
        <!-- small item: EN hidden behind disclosure -->
        <details
          v-if="other(question.text)"
          class="group mt-1"
        >
        ...
        <div
          v-if="question.nist?.length"
          class="mt-2 flex flex-wrap gap-1"
        >
          <span
            v-for="n in question.nist"
            :key="n"
      ...
      >
        ...
        >
          ...
          <span class="min-w-0 flex-1">
            ...
            <span
              v-if="other(lvl.scenario)"
              class="mt-0.5 block text-xs text-stone-500 italic leading-snug"
            >
              {{ other(lvl.scenario) }}
            </span>
          </span>
